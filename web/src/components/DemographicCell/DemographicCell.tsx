...
export const Empty = (props: DemographicProps) => <DemographicComponent {...props} />
    ...
    <Form onSubmit={onSubmit} config={{ mode: 'onBlur'}}>
      ...
      <Stack direction='column' gap={8} alignItems="start">
        <LikertScaleQuestionField
          ...
          text={['0-15 years old', '15-30 years old', '30-45 years old', '45-60 years old', '60+', 'Prefer not to say']}
          direction="column"
        ...
        <LikertScaleQuestionField
          ...
          text={['CFC/Apprenticeship', 'Maturité/Baccalauréat', 'Bachelors Degree', 'Masters Degree', 'Ph.D or higher', 'Prefer not to say']}
          direction="column"
        ...
        <LikertScaleQuestionField
          ...
          text={['I am not familiar with it', 'I heard about it', 'I am familiar with it', 'Prefer not to say']}
          direction="column"
        ...
        <LikertScaleQuestionField
          ...
          text={['I need the help of a technical person', 'I manage it', 'I am very comfortable', 'Prefer not to say']}
          direction="column"
